...
public class DataDummy {
    ...
    public static List<DataEntity> generateDummyMovie() {
        ...
        film.add(new DataEntity("804435",
                "Vanquish",
                "2021-04-16",
        ...
        film.add(new DataEntity("632357",
                "The Unholy",
                "2021-03-31",
        ...
        film.add(new DataEntity("726684",
                ...
                "7.9",
                "https://image.tmdb.org/t/p/original/msI5a9TPnepx47JUb2vl88hb80R.jpg"));
        film.add(new DataEntity("615678",
                "Thunder Force",
                "2021-04-09",
                "In a world where supervillains are commonplace, two estranged childhood best friends reunite after one devises a treatment that gives them powers to protect their city.",
                "5.8",
                "https://image.tmdb.org/t/p/original/duK11VQd4UPDa7UJrgrGx90xJOx.jpg"));
    ...
    public static List<DataEntity> generateDummyShow() {

        ArrayList<DataEntity> show = new ArrayList<>();

        show.add(new DataEntity("88396",
                "The Falcon and the Winter Soldier",
                "2021-03-19",
                "Following the events of “Avengers: Endgame”, the Falcon, Sam Wilson and the Winter Soldier, Bucky Barnes team up in a global adventure that tests their abilities, and their patience.",
                "7.9",
                "https://image.tmdb.org/t/p/original/6kbAMLteGO8yyewYau6bJ683sw7.jpg"));
        show.add(new DataEntity("93484",
                "Jupiter's Legacy",
                "2021-05-07",
        ...
        show.add(new DataEntity("105971",
                "The Bad Batch",
                "2021-05-04",
